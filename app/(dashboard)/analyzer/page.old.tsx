  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h1 className="text-2xl font-bold">Analises anteriores</h1>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            <CardTitle>Edital 1</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm">Descrição do edital 1</p>
          </CardContent>
          <CardFooter>
      ...
      <Card>
        ...
        {isLoading && (
          <CardFooter className="flex flex-col gap-2">
            ...
            {/* Ajuste o progresso conforme necessário */}
            <p className="text-sm text-muted-foreground">
              Processando arquivo...
            </p>
          </CardFooter>
